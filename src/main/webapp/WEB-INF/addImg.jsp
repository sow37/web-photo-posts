<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <div class="container">
            ...
            <input type="hidden" value="${ param.album }" name="album">
            <div class="body">
            	<p class="error"><c:out value="${ form.vide }"/></p>
                <div>
                    <span class="input-title">Titre</span>
                    <br>
                    <input type="text" class="form-control body-input" id="titre" name="titre" placeholder="Titre de l'image...">
                    <span class="error">${ form.titre }</span>
                </div>
                <div>
                    ...
                    <textarea class="form-control body-input" id="description" placeholder="Description de l'image..."
                        name="description"></textarea>
                         <span class="error">${ form.description }</span>
                </div>
                <div>
